...
parser.add_argument('--weapp-mini-id', type=str, default='', help='WeChat mini program id')
parser.add_argument('--weapp-mini-secret', type=str, default='', help='WeChat mini program secret')
parser.add_argument('--weapp-web-id', type=str, default='', help='WeChat mini program id')
parser.add_argument('--weapp-web-secret', type=str, default='', help='WeChat mini program secret')
