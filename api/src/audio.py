...
class AudioGenerate:
    ...
    async def generate_audio_async_v2(self, text: str, voice: str) -> str:
        audio_uid = f'{uuid.uuid4()}'
        db.new_audio(audio_uid)
    ...
    async def generate_audio_v2(self, text: str, voice: str, audio_uid: str) -> str:
        ...
        audio_s3_url = simulator['audio_url']
        audio_hash = simulator['audio_file_cid']
        audio_text = simulator['text']
    ...
    async def fetch_audio_v2(
        ...
        payload = {
            'text': text,
            'prompt_audio_hash': voice_audio_hash,
