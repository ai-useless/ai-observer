...
# docker run --gpus all --rm -it -v $OUTPUT_DIR/cache:/home/chutes/.cache -v $OUTPUT_DIR/pretrained_models:/app/pretrained_models --user 1000:1000 -e CHUTES_EXECUTION_CONTEXT=REMOTE -p 8800:8000 cosy-voice-tts:0.0.6 chutes run cosy_voice_tts:chute --port 8000 --dev
