...
export const COUNT_SIMULATORS_API =
  'http://47.117.36.214:8091/api/v1/count_simulators'
export const GET_SIMULATORS_API = 'http://47.117.36.214:8091/api/v1/simulators'
export const GET_USER = 'http://47.117.36.214:8091/api/v1/user'
export const COOK_USER = 'http://47.117.36.214:8091/api/v1/cook_user'
export const GET_MODELS_API = 'http://47.117.36.214:8091/api/v1/models'
