...
export const IntentPrompt = new Map<Intent, IntentFunc>([
  ...
  [
    Intent.CLASSIC_SCRIPTS,
    ((historyTopics: string[]) =>
      `你是相声剧本大全图书馆，用户需要你随机选取一对相声演员，查找他们表演的最少5个，最多20个互联网收录的台词字数超过2000个中文字的对口相声剧本。
       注意，不是要你创作，而是查找已经表演过剧本的，其中不包含用户之前已经观看过的节目，并随机选取1个剧本返回全部文本，返回应包含开场、过渡、展开、谢场等剧本必须部分，
