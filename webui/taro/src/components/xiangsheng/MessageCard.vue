<template>
  ...
  >
    ...
    <View style='padding-bottom: 4px; line-height: 18px; padding-top: 4px; padding-bottom: 4px; display: flex; flex-wrap: wrap; justify-content: center; align-items: center; color: white;'>
