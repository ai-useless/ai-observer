<template>
  ...
  >
    ...
    <div style='padding-bottom: 4px; line-height: 18px; padding-top: 4px; padding-bottom: 4px; display: flex; flex-wrap: wrap; justify-content: center; align-items: center;'>
      <div class='text-grey-8'>
        {{ message.participator.role === dbModel.Role.HOST ? '逗哏' : '捧哏' }}
      </div>
    ...
    <div v-if='message.last && !message.typing' style='font-size: 20px; padding: 16px 0; text-align: center;' class='text-grey-8'>
      谢谢观看！下一场表演更精彩！
    </div>
  </div>
</template>
