...
const items = ref<ListItem[]>([
  {
    title: '灵魂一问：没谱儿AGI和播客有什么区别？',
    content: '我们也很想蹭播客的热度，说我们是可以说方言的播客产品。然而，我们真的不是播客！现阶段我们专注于实时内容音频直播，下一阶段我们将会引入好玩的数字人角色和视频。我们没有给产品定义多么高远的调性，也没有定义任何远大的目标，所有我们想做的只是构建一些自己喜欢的东西，给自己提供高级的快乐，当然如果刚好也可以给您提供一些高级的快乐，那对我们当然是更加高级的快乐。全世界都要我们上进的时候，我们只想构建一个好玩的地方，来安放我们不安的灵魂！'
  },
  {
    title: '没谱儿AGI是免费的吗？',
    content: '没谱儿AGI提供免费计划。登录用户在当前阶段可以免费使用和观看应用内的所有AGI功能和内容。没谱儿AGI下一阶段将推出不同的订阅套餐，为用户提供高质量内容生成、数字人、视频生成、一键分享、存储计划、栏目预约、和朋友一起玩等高级功能，敬请期待！'
  },
  {
    title: '早鸟用户是否拥有额外福利？',
  ...
  {
    title: '我创建的角色是我独有的吗？',
    content: '在当前阶段，任何人创建的角色都是全平台可见的。我们将来将会支持用户独有的角色。'
  },
  {
    title: '我还能找到我听过的内容吗？',
    content: '当前版本我们不存储任何内容，内容都是实时生成的。我们将来将会上线存储计划，让用户可以存储自己听过的感兴趣的内容。'
  },
  {
    title: '我可以将感兴趣的内容分享给朋友吗？',
    content: '当前版本暂时还不能分享，但是将来我们将会支持将觉得有趣的内容分享给朋友。'
  },
  {
    title: '我可以邀请好友一起听好玩的内容吗？',
    content: '当前版本我们并不能支持在线上一起听好玩的内容，但是将来我们将会支持剧场版本，使得好朋友可以一起观看有趣的内容。'
  },
  {
    title: '我能找到跟我观看过类似内容的好友吗？',
    content: '当前版本我们没有做任何用户观看过的内容整理和收集，因此你并不能找到跟你看过同样内容的好友。我们并不确定将来是否需要支持这一功能，当然，这完全取决于有多少人需要。'
  },
  {
    title: '同一段佛经两次生成的音乐为什么不一样？',
    content: '鉴于没谱儿AGI的所有内容都是AGI实时生成，即使完全相同的内容，AGI也会给出略有差异或完全不同的答案，因此一段佛经的两次配乐可能是不一样的，同一个角色两次念诵佛经的语气也可能是不一样的。这和人的行为一样，不是吗？'
  }
])
