  ...
  [
    ...
    ((
      ...
      speakDuration: number
                                       ...
                                       4) 人物情绪普遍理性客观中立，但带有各自社群特征 5) 不要包含分析过程`) as IntentFunc
  ],
  [
    Intent.START_TOPIC,
    ((
      ...
      speakDuration: number
                                       ...
                                       3) 人物情绪普遍理性客观中立，但带有各自社群特征 4) 不要包含分析过程`) as IntentFunc
  ],
  [
    ...
    ((
      ...
      speakDuration: number
                                       ...
                                       1)直接输出发言内容，不允许有表情，标签，换行符和提示 2) 发言时间≤${speakDuration}秒，小于100字 3) 人物情绪普遍理性客观中立，但带有各自社群特征 4) 不要包含分析过程`) as IntentFunc
  ],
  [
