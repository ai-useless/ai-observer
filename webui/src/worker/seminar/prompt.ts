  ...
  [
    ...
    ((
      ...
      speakDuration: number
          ...
          8) 要html格式，不要返回markdown 9) 把连续多个空格合并成一个 10) 行高1.5em 11) 根据语义需要分段 12) 不要生硬的用主题开头`) as IntentFunc
  ],
  [
    Intent.START_TOPIC,
    ((
      ...
      speakDuration: number
          ...
          8) 把连续多个空格合并成一个 9) 一级标题用20号字加粗，二级标题用16号字加粗，普通内容不加粗，行高1.5em 10) 根据语义需要分段 11) 不要生硬的用主题开头`) as IntentFunc
  ],
  [
    ...
    ((
      ...
      speakDuration: number
          ...
          9) 一级标题用20号字加粗，二级标题用16号字加粗，普通内容不加粗，行高1.5em 10) 根据语义需要分段 11) 不要生硬的用主题开头`) as IntentFunc
  ],
  [
