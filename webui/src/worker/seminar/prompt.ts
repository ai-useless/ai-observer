  ...
  [
    ...
    ((
      ...
      rounds: number
          ...
          要求: 1) 行首不要有空格 2) 分级资料按照2个空格缩进 3) 要html格式，不要返回markdown 4) 不同层级标题用不同字号加粗`) as IntentFunc
  ],
  [
    Intent.DISCUSS,
    ((
      ...
      speakDuration: number
          ...
          8) 要html格式，不要返回markdown 9) 把连续多个空格合并成一个  10) 不同层级标题用不同字号加粗`) as IntentFunc
  ],
  [
    Intent.START_TOPIC,
    ((
      ...
      speakDuration: number
          ...
          8) 把连续多个空格合并成一个 9) 不同层级标题用不同字号加粗`) as IntentFunc
  ],
  [
    ...
    ((
      ...
      speakDuration: number
          ...
          4) 不要包含分析过程 5) 行首不要有空格 6) 分级资料按照2个空格缩进 7) 要html格式，不要返回markdown 8) 把连续多个空格合并成一个 9) 不同层级标题用不同字号加粗`) as IntentFunc
  ],
  [
